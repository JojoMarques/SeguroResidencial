...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Evento> eventosPacoteCobertura1 = new ArrayList<>();
        eventosPacoteCobertura1.add(evento1);
        eventosPacoteCobertura1.add(evento2);
        eventosPacoteCobertura1.add(evento3);

        ArrayList<Evento> eventosPacoteCobertura2 = new ArrayList<>();
        eventosPacoteCobertura2.add(evento2);
        eventosPacoteCobertura2.add(evento4);
        ...
        ArrayList<Servico> servicosPacoteAssistencia1 = new ArrayList<>();
        servicosPacoteAssistencia1.add(servico1);
        servicosPacoteAssistencia1.add(servico2);
        servicosPacoteAssistencia1.add(servico3);

        ArrayList<Servico> servicosPacoteAssistencia2 = new ArrayList<>();
        servicosPacoteAssistencia2.add(servico3);
        servicosPacoteAssistencia2.add(servico4);
        servicosPacoteAssistencia2.add(servico5);
        ...
        Seguro seguro1 = new Seguro(2000.00, 1, 1, Date.valueOf("2023-01-01"), Date.valueOf("2024-01-01"), 1);
        Seguro seguro2 = new Seguro(3000.00, 1, 2, Date.valueOf("2023-02-01"), Date.valueOf("2024-02-01"), 2);
